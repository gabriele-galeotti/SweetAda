...
package body MMIO is
   ...
   -- Unsigned_8
   function ReadN_U8 (Memory_Address : System.Address) return Interfaces.Unsigned_8 is
   separate;
   procedure WriteN_U8 (Memory_Address : in System.Address; Value : in Interfaces.Unsigned_8) is
   separate;

   -- Unsigned_16
   function ReadN_U16 (Memory_Address : System.Address) return Interfaces.Unsigned_16 is
   separate;
   ...
   -- Unsigned_8
   function ReadS_U8 (Memory_Address : System.Address) return Interfaces.Unsigned_8 is
   separate;
   procedure WriteS_U8 (Memory_Address : in System.Address; Value : in Interfaces.Unsigned_8) is
   separate;

   -- Unsigned_16
   function ReadS_U16 (Memory_Address : System.Address) return Interfaces.Unsigned_16 is
   separate;
   procedure WriteS_U16 (Memory_Address : in System.Address; Value : in Interfaces.Unsigned_16) is
   separate;

   -- Unsigned_32
   function ReadS_U32 (Memory_Address : System.Address) return Interfaces.Unsigned_32 is
   separate;
   ...
   -- Unsigned_16
   function ReadAS_U16 (Memory_Address : System.Address) return Interfaces.Unsigned_16 is
   separate;
   procedure WriteAS_U16 (Memory_Address : in System.Address; Value : in Interfaces.Unsigned_16) is
   separate;
