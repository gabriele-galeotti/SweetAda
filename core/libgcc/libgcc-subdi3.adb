...
function SubDI3
   ...
   A1_HIGH : GCC.Types.USI_Type renames T_A1 (HI64);
   A1_LOW  : GCC.Types.USI_Type renames T_A1 (LO64);
   A2_HIGH : GCC.Types.USI_Type renames T_A2 (HI64);
   A2_LOW  : GCC.Types.USI_Type renames T_A2 (LO64);
   R       : USI_2;
