...
pragma Style_Checks (Off);
   ...
   IA32_MONITOR_FILTER_SIZE      : constant MSR_Type := 16#0000_0006#; -- reported also as IA32_MONITOR_FILTER_LINE_SIZE
   ...
   IA32_PERFEVTSEL0              : constant MSR_Type := 16#0000_0186#;
   IA32_PERFEVTSEL1              : constant MSR_Type := 16#0000_0187#;
   IA32_PERFEVTSEL2              : constant MSR_Type := 16#0000_0188#;
   IA32_PERFEVTSEL3              : constant MSR_Type := 16#0000_0189#;
   IA32_PERF_STATUS              : constant MSR_Type := 16#0000_0198#;
   IA32_PERF_CTL                 : constant MSR_Type := 16#0000_0199#;
   IA32_CLOCK_MODULATION         : constant MSR_Type := 16#0000_019A#;
   IA32_THERM_INTERRUPT          : constant MSR_Type := 16#0000_019B#;
   IA32_THERM_STATUS             : constant MSR_Type := 16#0000_019C#;
   IA32_MISC_ENABLE              : constant MSR_Type := 16#0000_01A0#;
   IA32_ENERGY_PERF_BIAS         : constant MSR_Type := 16#0000_01B0#;
   IA32_PACKAGE_THERM_STATUS     : constant MSR_Type := 16#0000_01B1#;
   IA32_PACKAGE_THERM_INTERRUPT  : constant MSR_Type := 16#0000_01B2#;
   IA32_DEBUGCTL                 : constant MSR_Type := 16#0000_01D9#;
   IA32_SMRR_PHYSBASE            : constant MSR_Type := 16#0000_01F2#;
   IA32_SMRR_PHYSMASK            : constant MSR_Type := 16#0000_01F3#;
   IA32_PLATFORM_DCA_CAP         : constant MSR_Type := 16#0000_01F8#;
   IA32_CPU_DCA_CAP              : constant MSR_Type := 16#0000_01F9#;
   IA32_DCA_0_CAP                : constant MSR_Type := 16#0000_01FA#;
   IA32_MTRR_PHYSBASE0           : constant MSR_Type := 16#0000_0200#;
   IA32_MTRR_PHYSMASK0           : constant MSR_Type := 16#0000_0201#;
   IA32_MTRR_PHYSBASE1           : constant MSR_Type := 16#0000_0202#;
   IA32_MTRR_PHYSMASK1           : constant MSR_Type := 16#0000_0203#;
   IA32_MTRR_PHYSBASE2           : constant MSR_Type := 16#0000_0204#;
   IA32_MTRR_PHYSMASK2           : constant MSR_Type := 16#0000_0205#;
   IA32_MTRR_PHYSBASE3           : constant MSR_Type := 16#0000_0206#;
   IA32_MTRR_PHYSMASK3           : constant MSR_Type := 16#0000_0207#;
   IA32_MTRR_PHYSBASE4           : constant MSR_Type := 16#0000_0208#;
   IA32_MTRR_PHYSMASK4           : constant MSR_Type := 16#0000_0209#;
   IA32_MTRR_PHYSBASE5           : constant MSR_Type := 16#0000_020A#;
   IA32_MTRR_PHYSMASK5           : constant MSR_Type := 16#0000_020B#;
   IA32_MTRR_PHYSBASE6           : constant MSR_Type := 16#0000_020C#;
   IA32_MTRR_PHYSMASK6           : constant MSR_Type := 16#0000_020D#;
   IA32_MTRR_PHYSBASE7           : constant MSR_Type := 16#0000_020E#;
   IA32_MTRR_PHYSMASK7           : constant MSR_Type := 16#0000_020F#;
   IA32_MTRR_PHYSBASE8           : constant MSR_Type := 16#0000_0210#;
   IA32_MTRR_PHYSMASK8           : constant MSR_Type := 16#0000_0211#;
   IA32_MTRR_PHYSBASE9           : constant MSR_Type := 16#0000_0212#;
   IA32_MTRR_PHYSMASK9           : constant MSR_Type := 16#0000_0213#;
   IA32_MTRR_FIX64K_00000        : constant MSR_Type := 16#0000_0250#;
   IA32_MTRR_FIX16K_80000        : constant MSR_Type := 16#0000_0258#;
   IA32_MTRR_FIX16K_A0000        : constant MSR_Type := 16#0000_0259#;
   IA32_MTRR_FIX4K_C0000         : constant MSR_Type := 16#0000_0268#;
   IA32_MTRR_FIX4K_C8000         : constant MSR_Type := 16#0000_0269#;
   IA32_MTRR_FIX4K_D0000         : constant MSR_Type := 16#0000_026A#;
   IA32_MTRR_FIX4K_D8000         : constant MSR_Type := 16#0000_026B#;
   IA32_MTRR_FIX4K_E0000         : constant MSR_Type := 16#0000_026C#;
   IA32_MTRR_FIX4K_E8000         : constant MSR_Type := 16#0000_026D#;
   IA32_MTRR_FIX4K_F0000         : constant MSR_Type := 16#0000_026E#;
   IA32_MTRR_FIX4K_F8000         : constant MSR_Type := 16#0000_026F#;
   IA32_PAT                      : constant MSR_Type := 16#0000_0277#;
   IA32_MC0_CTL2                 : constant MSR_Type := 16#0000_0280#;
   IA32_MC1_CTL2                 : constant MSR_Type := 16#0000_0281#;
   IA32_MC2_CTL2                 : constant MSR_Type := 16#0000_0282#;
   IA32_MC3_CTL2                 : constant MSR_Type := 16#0000_0283#;
   IA32_MC4_CTL2                 : constant MSR_Type := 16#0000_0284#;
   IA32_MC5_CTL2                 : constant MSR_Type := 16#0000_0285#;
   IA32_MC6_CTL2                 : constant MSR_Type := 16#0000_0286#;
   IA32_MC7_CTL2                 : constant MSR_Type := 16#0000_0287#;
   IA32_MC8_CTL2                 : constant MSR_Type := 16#0000_0288#;
   IA32_MC9_CTL2                 : constant MSR_Type := 16#0000_0289#;
   IA32_MC10_CTL2                : constant MSR_Type := 16#0000_028A#;
   IA32_MC11_CTL2                : constant MSR_Type := 16#0000_028B#;
   IA32_MC12_CTL2                : constant MSR_Type := 16#0000_028C#;
   IA32_MC13_CTL2                : constant MSR_Type := 16#0000_028D#;
   IA32_MC14_CTL2                : constant MSR_Type := 16#0000_028E#;
   IA32_MC15_CTL2                : constant MSR_Type := 16#0000_028F#;
   IA32_MC16_CTL2                : constant MSR_Type := 16#0000_0290#;
   IA32_MC17_CTL2                : constant MSR_Type := 16#0000_0291#;
   IA32_MC18_CTL2                : constant MSR_Type := 16#0000_0292#;
   IA32_MC19_CTL2                : constant MSR_Type := 16#0000_0293#;
   IA32_MC20_CTL2                : constant MSR_Type := 16#0000_0294#;
   IA32_MC21_CTL2                : constant MSR_Type := 16#0000_0295#;
   IA32_MC22_CTL2                : constant MSR_Type := 16#0000_0296#;
   IA32_MC23_CTL2                : constant MSR_Type := 16#0000_0297#;
   IA32_MC24_CTL2                : constant MSR_Type := 16#0000_0298#;
   IA32_MC25_CTL2                : constant MSR_Type := 16#0000_0299#;
   IA32_MC26_CTL2                : constant MSR_Type := 16#0000_029A#;
   IA32_MC27_CTL2                : constant MSR_Type := 16#0000_029B#;
   IA32_MC28_CTL2                : constant MSR_Type := 16#0000_029C#;
   IA32_MC29_CTL2                : constant MSR_Type := 16#0000_029D#;
   IA32_MC30_CTL2                : constant MSR_Type := 16#0000_029E#;
   IA32_MC31_CTL2                : constant MSR_Type := 16#0000_029F#;
   IA32_MTRR_DEF_TYPE            : constant MSR_Type := 16#0000_02FF#;
   IA32_FIXED_CTR0               : constant MSR_Type := 16#0000_0309#;
   IA32_FIXED_CTR1               : constant MSR_Type := 16#0000_030A#;
   IA32_FIXED_CTR2               : constant MSR_Type := 16#0000_030B#;
   IA32_PERF_CAPABILITIES        : constant MSR_Type := 16#0000_0345#;
   IA32_FIXED_CTR_CTRL           : constant MSR_Type := 16#0000_038D#;
   IA32_PERF_GLOBAL_STATUS       : constant MSR_Type := 16#0000_038E#;
   IA32_PERF_GLOBAL_CTRL         : constant MSR_Type := 16#0000_038F#;
   IA32_PERF_GLOBAL_OVF_CTRL     : constant MSR_Type := 16#0000_0390#;
   IA32_PERF_GLOBAL_STATUS_RESET : constant MSR_Type := 16#0000_0390#;
   IA32_PERF_GLOBAL_STATUS_SET   : constant MSR_Type := 16#0000_0391#;
   IA32_PERF_GLOBAL_INUSE        : constant MSR_Type := 16#0000_0392#;
   IA32_PEBS_ENABLE              : constant MSR_Type := 16#0000_03F1#;
   -- ...
   IA32_EFER                     : constant MSR_Type := 16#C000_0080#;
   IA32_STAR                     : constant MSR_Type := 16#C000_0081#;
   IA32_LSTAR                    : constant MSR_Type := 16#C000_0082#;
   IA32_FMASK                    : constant MSR_Type := 16#C000_0084#;
   IA32_FS_BASE                  : constant MSR_Type := 16#C000_0100#;
   IA32_GS_BASE                  : constant MSR_Type := 16#C000_0101#;
