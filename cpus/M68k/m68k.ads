...
pragma Style_Checks (Off);
   ...
   Reset_Initial_Stack_Pointer       : constant := 0;
   ...
   Level1_Autovector                 : constant := 25;
   Level2_Autovector                 : constant := 26;
   Level3_Autovector                 : constant := 27;
   Level4_Autovector                 : constant := 28;
   Level5_Autovector                 : constant := 29;
   Level6_Autovector                 : constant := 30;
   Level7_Autovector                 : constant := 31;
   Trap_0                            : constant := 32;
   Trap_1                            : constant := 33;
   Trap_2                            : constant := 34;
   Trap_3                            : constant := 35;
