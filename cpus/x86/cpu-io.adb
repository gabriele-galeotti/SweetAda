...
package body CPU.IO is
   ...
   function A_To_U32 is new Ada.Unchecked_Conversion (Address, Unsigned_32);

   -- Unsigned_8
   function IO_Read (Port_Address : Address) return Unsigned_8 is
   begin
      return PortIn (Unsigned_16 (A_To_U32 (Port_Address) and 16#0000_FFFF#));
   end IO_Read;
   procedure IO_Write (Port_Address : in Address; Value : in Unsigned_8) is
   begin
      PortOut (Unsigned_16 (A_To_U32 (Port_Address) and 16#0000_FFFF#), Value);
   end IO_Write;
