...
set XILINX_PATH       /opt/Xilinx/12.4/ISE_DS
# top-level directory of the project
set PROJECT_PATH      /root/project/hardware/Xilinx_MemecFX12/XC4VFX12_base_design
set BOOTLOOP_ELF_FILE [file join $XILINX_PATH EDK/sw/lib/ppc405/ppc_bootloop.elf]
set SWEETADA_ELF_FILE [file join $::env(SWEETADA_PATH) $::env(KERNEL_BASENAME).elf]
set DEVICE            xc4vfx12sf363-10
