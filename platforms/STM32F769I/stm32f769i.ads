...
pragma Warnings (On);
   ...
   ADDSET_HCLK0  : constant := 2#0000#; -- ADDSET phase duration = 0 × HCLK clock cycle
   ADDSET_HCLK1  : constant := 2#0001#; -- ADDSET phase duration = 1 × HCLK clock cycles
   ADDSET_HCLK2  : constant := 2#0010#; -- ADDSET phase duration = 2 × HCLK clock cycles
   ADDSET_HCLK3  : constant := 2#0011#; -- ADDSET phase duration = 3 × HCLK clock cycles
   ADDSET_HCLK4  : constant := 2#0100#; -- ADDSET phase duration = 4 × HCLK clock cycles
   ADDSET_HCLK5  : constant := 2#0101#; -- ADDSET phase duration = 5 × HCLK clock cycles
   ADDSET_HCLK6  : constant := 2#0110#; -- ADDSET phase duration = 6 × HCLK clock cycles
   ADDSET_HCLK7  : constant := 2#0111#; -- ADDSET phase duration = 7 × HCLK clock cycles
   ADDSET_HCLK8  : constant := 2#1000#; -- ADDSET phase duration = 8 × HCLK clock cycles
   ADDSET_HCLK9  : constant := 2#1001#; -- ADDSET phase duration = 9 × HCLK clock cycles
   ADDSET_HCLK10 : constant := 2#1010#; -- ADDSET phase duration = 10 × HCLK clock cycles
   ADDSET_HCLK11 : constant := 2#1011#; -- ADDSET phase duration = 11 × HCLK clock cycles
   ADDSET_HCLK12 : constant := 2#1100#; -- ADDSET phase duration = 12 × HCLK clock cycles
   ADDSET_HCLK13 : constant := 2#1101#; -- ADDSET phase duration = 13 × HCLK clock cycles
   ADDSET_HCLK14 : constant := 2#1110#; -- ADDSET phase duration = 14 × HCLK clock cycles
   ADDSET_HCLK15 : constant := 2#1111#; -- ADDSET phase duration = 15 × HCLK clock cycles

   ADDHLD_RSVD     : constant := 2#0000#; -- Reserved
   ADDHLD_HCLK1    : constant := 2#0001#; -- ADDHLD phase duration = 1 × HCLK clock cycle
   ADDHLD_HCLK2    : constant := 2#0010#; -- ADDHLD phase duration = 2 × HCLK clock cycles
   ADDHLD_HCLK3    : constant := 2#0011#; -- ADDHLD phase duration = 3 × HCLK clock cycles
   ADDHLD_HCLK4    : constant := 2#0100#; -- ADDHLD phase duration = 4 × HCLK clock cycles
   ADDHLD_HCLK5    : constant := 2#0101#; -- ADDHLD phase duration = 5 × HCLK clock cycles
   ADDHLD_HCLK6    : constant := 2#0110#; -- ADDHLD phase duration = 6 × HCLK clock cycles
   ADDHLD_HCLK7    : constant := 2#0111#; -- ADDHLD phase duration = 7 × HCLK clock cycles
   ADDHLD_HCLK8    : constant := 2#1000#; -- ADDHLD phase duration = 8 × HCLK clock cycles
   ADDHLD_HCLK9    : constant := 2#1001#; -- ADDHLD phase duration = 9 × HCLK clock cycles
   ADDHLD_HCLK10   : constant := 2#1010#; -- ADDHLD phase duration = 10 × HCLK clock cycles
   ADDHLD_HCLK11   : constant := 2#1011#; -- ADDHLD phase duration = 11 × HCLK clock cycles
   ADDHLD_HCLK12   : constant := 2#1100#; -- ADDHLD phase duration = 12 × HCLK clock cycles
   ADDHLD_HCLK13   : constant := 2#1101#; -- ADDHLD phase duration = 13 × HCLK clock cycles
   ...
   BUSTURN_HCLK2  : constant := 2#0010#; -- BUSTURN phase duration = 2 × HCLK clock cycles added
   BUSTURN_HCLK3  : constant := 2#0011#; -- BUSTURN phase duration = 3 × HCLK clock cycles added
   BUSTURN_HCLK4  : constant := 2#0100#; -- BUSTURN phase duration = 4 × HCLK clock cycles added
   BUSTURN_HCLK5  : constant := 2#0101#; -- BUSTURN phase duration = 5 × HCLK clock cycles added
   BUSTURN_HCLK6  : constant := 2#0110#; -- BUSTURN phase duration = 6 × HCLK clock cycles added
   BUSTURN_HCLK7  : constant := 2#0111#; -- BUSTURN phase duration = 7 × HCLK clock cycles added
   BUSTURN_HCLK8  : constant := 2#1000#; -- BUSTURN phase duration = 8 × HCLK clock cycles added
   BUSTURN_HCLK9  : constant := 2#1001#; -- BUSTURN phase duration = 9 × HCLK clock cycles added
   BUSTURN_HCLK10 : constant := 2#1010#; -- BUSTURN phase duration = 10 × HCLK clock cycles added
   BUSTURN_HCLK11 : constant := 2#1011#; -- BUSTURN phase duration = 11 × HCLK clock cycles added
   BUSTURN_HCLK12 : constant := 2#1100#; -- BUSTURN phase duration = 12 × HCLK clock cycles added
   BUSTURN_HCLK13 : constant := 2#1101#; -- BUSTURN phase duration = 13 × HCLK clock cycles added
   BUSTURN_HCLK14 : constant := 2#1110#; -- BUSTURN phase duration = 14 × HCLK clock cycles added
   BUSTURN_HCLK15 : constant := 2#1111#; -- BUSTURN phase duration = 15 × HCLK clock cycles added
   ...
   type FMC_BTRx_Type is record
      ADDSET   : Bits_4 := ADDSET_HCLK15;  -- Address setup phase duration
      ADDHLD   : Bits_4 := ADDHLD_HCLK15;  -- Address-hold phase duration
      DATAST   : Bits_8 := DATAST_HCLK255; -- Data-phase duration
      BUSTURN  : Bits_4 := BUSTURN_HCLK15; -- Bus turnaround phase duration
   ...
   -- ADDSET_* already defined at FMC_BTRx
   -- ADDHLD_* already defined at FMC_BTRx
   -- DATAST_* already defined at FMC_BTRx
   -- BUSTURN_* already defined at FMC_BTRx
