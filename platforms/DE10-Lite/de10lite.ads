...
package DE10Lite is
   ...
   LEDs_IO : aliased Unsigned_32 with
      Address    => To_Address (leds_s1_ADDRESS),
      Volatile   => True,
      Import     => True,
      Convention => Ada;

   LEDs_Dir : aliased Unsigned_32 with
      Address    => To_Address (leds_s1_ADDRESS + 4),
      Volatile   => True,
      Import     => True,
      Convention => Ada;
   ...
   type JTAG_UART_control_Type is
   record
      ...
      Bit_Order => Low_Order_First,
      Size      => 32;
   for JTAG_UART_control_Type use
   record
      RE        at 0 range  0 ..  0;
      WE        at 0 range  1 ..  1;
